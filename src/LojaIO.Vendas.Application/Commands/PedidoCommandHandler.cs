...
using LojaIO.Core.DomainObjects.DTO;
using LojaIO.Core.Extensions;
...
namespace LojaIO.Vendas.Application.Commands
{
        ...
        IRequestHandler<IniciarPedidoCommand, bool>
    {
        ...
        public async Task<bool> Handle(IniciarPedidoCommand message, CancellationToken cancellationToken)
        {
            ...
            var listaProdutoPedido = new ListaProdutosPedido { PedidoId = pedido.Id, Itens = itensList };

            pedido.AdicionarEvento(new PedidoIniciadoEvent(pedido.Id, pedido.ClienteId, listaProdutoPedido, pedido.ValorTotal, message.NomeCartao, message.NumeroCartao, message.ExpiracaoCartao, message.CvvCartao));
